...
func NewModel(collectionName string, opts ...*ModelOptions) *Model {
	...
	return &Model{
		dao: ddd_mongodb.NewDao[*Entity](getCollCallback, ddd_mongodb.NewOptions().SetAutoCreateCollection(true).SetAutoCreateIndex(true).SetIsMapEntity(true)),
	}
}

func (d *Model) Save(ctx context.Context, setData *ddd.SetData[*Entity], opts ...*ddd_repository.RepositoryOptions) error {
	return d.dao.Save(ctx, setData, newOptions(opts)...).GetError()
}

func (d *Model) Insert(ctx context.Context, entity *Entity, opts ...*ddd_repository.RepositoryOptions) error {
	return d.dao.Insert(ctx, entity, newOptions(opts)...).GetError()
}

func (d *Model) InsertByMap(ctx context.Context, tenantId string, data map[string]any, opts ...*ddd_repository.RepositoryOptions) error {
	return d.dao.InsertMap(ctx, tenantId, data, newOptions(opts)...)
}

func (d *Model) InsertMany(ctx context.Context, entity []*Entity, opts ...*ddd_repository.RepositoryOptions) error {
	return d.dao.InsertMany(ctx, entity, newOptions(opts)...).GetError()
}

func (d *Model) Update(ctx context.Context, entity *Entity, opts ...*ddd_repository.RepositoryOptions) error {
...
func (d *Model) UpdateMany(ctx context.Context, entities []*Entity, opts ...*ddd_repository.RepositoryOptions) error {
...
func (d *Model) FindListByMap(ctx context.Context, tenantId string, filterMap map[string]interface{}, opts ...*ddd_repository.RepositoryOptions) *ddd_repository.FindListResult[*Entity] {
	return d.dao.FindListByMap(ctx, tenantId, filterMap, newOptions(opts)...)
}

func (d *Model) FindPaging(ctx context.Context, query *ddd_repository.FindPagingQueryRequest, opts ...*ddd_repository.RepositoryOptions) *ddd_repository.FindPagingResult[*Entity] {
	return d.dao.FindPaging(ctx, query, newOptions(opts)...)
}

func (d *Model) FindAutoComplete(ctx context.Context, qry *ddd_repository.FindAutoCompleteQueryRequest, opts ...*ddd_repository.RepositoryOptions) *ddd_repository.FindPagingResult[*Entity] {
