...
func RegisterApi(app *iris.Application, baseUrl string, env env.IEnvConfig, rootPath string) {
...
func RegisterHtml(app *iris.Application, baseUrl string, env env.IEnvConfig, rootPath string) {
