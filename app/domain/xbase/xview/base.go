...
type Base struct {
	...
	UpdatedTime *times.Time `json:"updatedTime,omitempty"  gorm:"updated_time;title:修改人ID" gorm:"updated_time" desc:"修改时间"`                 // 修改时间
	...
	DeletedTime *times.Time `json:"deletedTime,omitempty"  gorm:"deleted_time;title:删除时间" bson:"deleted_time" desc:"删除时间"`                  // 删除时间
