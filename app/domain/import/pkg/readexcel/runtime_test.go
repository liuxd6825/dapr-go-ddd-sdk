...
func TestField_toDateTime2(t *testing.T) {
	list := map[string][]string{}
	list["【入帐日期】: 20011227; 【入帐时间】: 11.1424;"] = []string{
		"20011227", "11.1424",
	}
	list["【入帐日期】: 20011225; 【入帐时间】: 1335.34;"] = []string{
		"20011225", "1335.34",
	}
	list["【入帐日期】: 20020116; 【入帐时间】: 13.32,27;"] = []string{
		"20020116", "13.32,27",
	}
	list["【入帐日期】: 20011203; 【入帐时间】: 15.5504;"] = []string{
		"20011203", "15.5504",
	}
	list["【入帐日期】: 20010912; 【入帐时间】: 1545.44;"] = []string{
		"20010912", "1545.44",
	}
	list["【入帐日期】: 20010912; 【入帐时间】: 15,45.44;"] = []string{
		"20010912", "15,45.44",
	}

	for k, v := range list {
		res := toDateTime(v[0], v[1])
		t.Log(k, "; 转换为: ", res)
	}
