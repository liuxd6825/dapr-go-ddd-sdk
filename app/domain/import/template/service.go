...
func NewTemplateService() *TemplateService {
	_templateOnce.Do(func() {
		_templateDomainService = &TemplateService{
			dao: NewTemplateDao(config.DBKey),
		}
	})
	return _templateDomainService
}

func (t *TemplateService) Create(ctx context.Context, cmd *TempCreateCommand) {
	temp := &Template{}
	temp.Id = cmd.Data.Id
...
func (t *TemplateService) Delete(ctx context.Context, cmd *TempDeleteCommand) error {
	return xbase.DoCommand(ctx, cmd, func(ctx context.Context) error {
		return t.dao.DeleteById(ctx, cmd.Data.Id).GetError()
	})
}

func (t *TemplateService) CreateMany(ctx context.Context, list []*Template) error {
	return t.dao.CreateMany(ctx, list).GetError()
}

func (t *TemplateService) Update(ctx context.Context, cmd *TempUpdateCommand) error {
	return xbase.DoCommand(ctx, cmd, func(ctx context.Context) error {
		temp := &Template{}
		temp.Id = cmd.Data.Id
		temp.CaseId = cmd.Data.CaseId
...
func (t *TemplateService) FindById(ctx context.Context, qry *TemplateFindByIdQuery) (*Template, error) {
...
func (t *TemplateService) FindPaging(ctx context.Context, caseId string, qry *TemplateFindPagingQuery) idao.FindPagingResult[*Template] {
