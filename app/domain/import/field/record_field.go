...
type RecordMetaFields struct {
	...
	Date   *FieldMeta `json:"date" bson:"date,omitempty" validate:"-" title:"交易时间"`     // 交易时间
	Notes  *FieldMeta `json:"notes" bson:"notes,omitempty" validate:"-" title:"交易备注"`   // 交易备注
	Place  *FieldMeta `json:"place" bson:"place,omitempty" validate:"-" title:"交易地点"`   // 交易地点
