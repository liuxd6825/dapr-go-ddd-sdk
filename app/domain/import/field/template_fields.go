...
type TempCreateField struct {
	...
	SheetId    string                 `json:"sheetId"  title:"页Id"`
	SchemaId   string                 `json:"schemaId"  title:"架构ID"`
	SchemaName string                 `json:"schemaName"  title:"架构名"`
	MapHeads   []*model.MapHead       `json:"mapHeads"  title:"表头"`
	Fields     []*model.TemplateField `json:"fields"  title:"字段"`
