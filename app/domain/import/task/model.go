...
type Task struct {
	...
	MapHeads  []*template.MapHead       `json:"mapHeads" gorm:"map_heads;type:json"  bson:"map_heads"`
	Fields    []*template.TemplateField `json:"fields,omitempty" gorm:"fields;type:json"  bson:"fields" desc:"模板"`
	State     TaskState                 `json:"state,omitempty" gorm:"state"  bson:"state" desc:"状态"`
