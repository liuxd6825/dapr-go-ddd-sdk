...
type DocumentMeta struct {
	xbase.BaseModel `bson:",inline"`
	DocumentId      string `gorm:"document_id" json:"documentId,omitempty" bson:"document_id" title:"来源"`   // 文档ID
	SourceType      string `gorm:"source_type" json:"sourceType,omitempty" bson:"source_type" title:"来源类型"` // 业务类型： 人员，公司，文档
	Source          string `gorm:"source" json:"source,omitempty" bson:"source" title:"来源"`                 // 业务数据的唯一id
