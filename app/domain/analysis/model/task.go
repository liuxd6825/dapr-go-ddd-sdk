...
import (
	...
	model3 "github.com/liuxd6825/dapr-go-ddd-sdk/app/domain/master/record/model"
...
type SuTran struct {
	...
	AcctType        model3.AccountType `json:"acctType" gorm:"acct_type" bson:"acct_type"  title:"我方账号类型"`
	...
	OppAcctType     model3.AccountType `json:"oppAcctType" gorm:"opp_acct_type" bson:"opp_acct_type" title:"对方账号类型"`
	OppBankName     string             `json:"oppBankName" gorm:"opp_bank_name"  bson:"opp_bank_name"  title:"对方开户银行"`
	Cash            model3.CashType    `json:"cash" gorm:"cash" bson:"cash" title:"现金"`
...
type AccountRecords struct {
	...
	Records   []*model3.Record `bson:"records" json:"records;type:json" bson:"records" title:"交易流水"`
}
