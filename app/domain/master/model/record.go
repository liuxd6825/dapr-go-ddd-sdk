...
type Record struct {
	...
	Iden            string     `json:"iden"   gorm:"iden" bson:"iden"   index:""  validate:"-" title:"我方标识"`                            // 标识
	...
	BankName        string     `json:"bankName"  gorm:"bank_name"  bson:"bank_name"   index:""   validate:"-" title:"我方开户银行"`           // 开户银行
	Balance         *float64   `json:"balance"  gorm:"balance"   bson:"balance"  index:""   validate:"-" title:"我方余额账户"`                // 余额账户
	OppIden         string     `json:"oppIden"   gorm:"opp_iden"  bson:"opp_iden"  index:""   validate:"-" title:"对方标识"`                // 对方标识
	...
	Type            string     `json:"type"  gorm:"type"   bson:"type"  index:""  validate:"-" title:"交易类型"`                            // 交易类型
	...
	DataSource      string     `json:"dataSource"   gorm:"data_source"  bson:"data_source"  index:""   validate:"-" title:"数据源"`
	DataSourceId    string     `json:"dataSourceId"   gorm:"data_source_id"  bson:"data_source_id"  index:""   validate:"-" title:"数据源id"`
	SuLarge         bool       `json:"suLarge"  gorm:"su_large" bson:"su_large"  index:""   validate:"-" title:"金额可疑" `
	SuInt           bool       `json:"suInt"  gorm:"su_int" bson:"su_int"  index:""   validate:"-" title:"整数可疑" `
	SuCollar        bool       `json:"suCollar" gorm:"su_collar"  bson:"su_collar"  index:""   validate:"-" title:"对敲可疑" `
	SuNear          bool       `json:"suNear"  gorm:"su_near" bson:"su_near"  index:""   validate:"-" title:"临界可疑" `
	RiskCount       int        `json:"riskCount"  gorm:"risk_count" bson:"risk_count"  index:""   validate:"-" title:"风险数" `
}
