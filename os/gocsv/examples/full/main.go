...
import (
	"encoding/csv"
	"fmt"
	gocsv2 "github.com/liuxd6825/dapr-go-ddd-sdk/os/gocsv"
	"io"
	"io/ioutil"
	"os"
	"time"
...
var _ gocsv2.TypeMarshaller = new(DateTime)
var _ gocsv2.TypeUnmarshaller = new(DateTime)
...
func Csv() error {
	...
	gocsv2.SetCSVReader(func(in io.Reader) gocsv2.CSVReader {
		r := csv.NewReader(in)
		r.Comma = ','
		return r
	})
	...
	if err = gocsv2.MarshalFile(&clients, clientsFile); err != nil {
		return err
	}
	...
	if err := gocsv2.UnmarshalFile(clientsFile, &newClients); err != nil {
		return err
	}
	fmt.Println("clients:")
