...
func (r *Dao[T]) Update(ctx context.Context, entity T, opts ...store2.Options) *store2.SetResult[T] {
...
func (r *Dao[T]) UpdateByRSQL(ctx context.Context, tenantId, filterRSQL string, data T, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
...
func (r *Dao[T]) UpdateMany(ctx context.Context, tenantId string, entities []T, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
...
func (r *Dao[T]) UpdateMapById(ctx context.Context, tenantId string, id string, data map[string]any, opts ...store2.Options) *store2.SetResult[T] {
...
func (r *Dao[T]) UpdateMap(ctx context.Context, tenantId string, id string, data map[string]any, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
...
func (r *Dao[T]) UpdateMapByRSQL(ctx context.Context, tenantId string, filterRSQL string, data map[string]any, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
		filter, err := r.getFilter(tenantId, filterRSQL)
		if err != nil {
...
func (r *Dao[T]) getUpdateData(ctx context.Context, tenantId string, data any, opts ...store2.Options) any {
	r.eb.SetUpdatedInfo(ctx, data)
...
func IncludeField(field *store2.Field, fields []string) bool {
