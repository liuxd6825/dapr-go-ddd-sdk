...
func newHumanDao() store2.IStore[*Human] {
...
func newRecordDao() store2.IStore[*Record] {
...
func TestMapper_Search(t *testing.T) {
	...
	t.Run("FindPagingQuery_Group", func(t *testing.T) {
		...
		qry.SetTenantId(TENANT_ID)
		qry.SetPageSize(20)
		qry.SetGroupCols(store2.NewGroupCols("").Add("name", types.DataTypeString).GetCols())
