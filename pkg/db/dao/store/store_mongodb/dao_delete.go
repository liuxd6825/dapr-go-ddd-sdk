...
func (r *Dao[T]) Delete(ctx context.Context, entity T, opts ...store2.Options) *store2.SetResult[T] {
	return r.DeleteById(ctx, r.GetTenantId(entity), r.GetId(entity), opts...)
}

func (r *Dao[T]) DeleteByRSQL(ctx context.Context, tenantId, rSQL string, opts ...store2.Options) *store2.SetResult[T] {
...
func (r *Dao[T]) DeleteById(ctx context.Context, tenantId string, id string, opts ...store2.Options) *store2.SetResult[T] {
...
func (r *Dao[T]) DeleteByIds(ctx context.Context, tenantId string, ids []string, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResult[T]()
...
func (r *Dao[T]) DeleteAll(ctx context.Context, tenantId string, opts ...store2.Options) *store2.SetResult[T] {
	data := map[string]interface{}{}
	return r.DeleteByMap(ctx, tenantId, data)
}

func (r *Dao[T]) DeleteMany(ctx context.Context, tenantId string, entities []T, opts ...store2.Options) *store2.SetResult[T] {
	var ids []string
...
func (r *Dao[T]) DeleteByMap(ctx context.Context, tenantId string, filterMap map[string]any, opts ...store2.Options) *store2.SetResult[T] {
	return r.deleteByAny(ctx, tenantId, filterMap, opts...)
}

func (r *Dao[T]) deleteByAny(ctx context.Context, tenantId string, filterAny any, opts ...store2.Options) *store2.SetResult[T] {
	...
	return store2.NewSetResultError[T](errors.New("filterMap is not map[string]any or *rsql_mongo.Filter"))
}
...
func (r *Dao[T]) deleteByFilter(ctx context.Context, tenantId string, filter *rsql_mongo.Filter, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
