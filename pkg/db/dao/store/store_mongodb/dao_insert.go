...
func (r *Dao[T]) InsertOrUpdate(ctx context.Context, entity T, opts ...store2.Options) *store2.SetResult[T] {
...
func (r *Dao[T]) Insert(ctx context.Context, entity T, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
...
// @param opts
// @return error
func (r *Dao[T]) InsertMap(ctx context.Context, tenantId string, data map[string]interface{}, opts ...store2.Options) (res *store2.SetResult[T]) {
	res = store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
		if err := assert2.NotEmpty(tenantId, assert2.NewOptions("tenantId is empty")); err != nil {
			return err
...
func (r *Dao[T]) InsertMany(ctx context.Context, tenantId string, entities []T, opts ...store2.Options) *store2.SetResult[T] {
	res := store2.NewSetResultEmpty[T]()
	gp.Try(func() error {
		sCtx := r.getSessionCtx(ctx)
