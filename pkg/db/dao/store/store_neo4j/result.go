...
import (
	...
	graph2 "github.com/liuxd6825/dapr-go-ddd-sdk/pkg/db/dao/store/graph"
...
func NewNeo4jResult[T any](ctx context.Context, eb store2.EntityBuilder[T], result neo4j.ResultWithContext, keys ...*KeyResult[interface{}]) *Neo4jResult[T] {
...
func (r *Neo4jResult[T]) SetMapEntity(schema *store2.DBSchema, neo4jData map[string]any, entity map[string]any) {
...
func (r *Neo4jResult[T]) GetList(ctx context.Context, key string, resList any, schema *store2.DBSchema, opts ...*MappingOptions) error {
...
// @return bool
// @return error
func (r *Neo4jResult[T]) GetOne(dataKey string, entity interface{}, schema *store2.DBSchema, opts ...*MappingOptions) (bool, error) {
...
func (r *Neo4jResult[T]) NewGraphNodes(list []any) []*graph2.Node {
	var resList []*graph2.Node
	for _, i := range list {
...
func (r *Neo4jResult[T]) NewGraphEdges(list []any) []*graph2.Edge {
	var resList []*graph2.Edge
	for _, i := range list {
...
func (r *Neo4jResult[T]) NewGraphView() *graph2.GraphView {
	graphView := graph2.NewGraphView()
