...
type NodeEntityBuilder[T any] interface {
	...
	GetLabels(e T, label ...string) []string
}
...
func (r *nodeEntityBuilder[T]) GetLabels(entity T, values ...string) []string {
	return store2.GetGraphLabels[T](r.GetDBSchema(), entity, values...)
}
