...
func getTypeConverters() []copier.TypeConverter {
	...
	typeConverters = append(typeConverters, times2.NewJsonDateConverter().GetTypeConverters()...)
	typeConverters = append(typeConverters, times2.NewJsonTimeConverter().GetTypeConverters()...)
