...
func updateCache(ty reflect.Type, o *RefObj) {
...
// RefObj is a wrapper for golang values which need to be reflected.
...
// NewRefObjFromType creates a new RefObj but using reflect.Type.
func NewRefObjFromType(ty reflect.Type) *RefObj {
	if ty == nil {
		return NewRefObj(nil)
	}
	return NewRefObj(reflect.New(ty).Interface())
}

// NewRefObj initializes a new RefObj wrapper.
func NewRefObj(obj interface{}) *RefObj {
	o := &RefObj{iface: obj}
...
func (o *RefObj) IsGettableByIndex() bool {
	switch o.fieldsValue.Kind() {
...
func (o *RefObj) IsSettableByIndex() bool {
	switch o.fieldsValue.Kind() {
...
func (o *RefObj) GetByIndex(index int) (value interface{}, found bool) {
	defer func() {
...
func (o *RefObj) SetByIndex(index int, val interface{}) error {
...
func (o *RefObj) Keys() ([]interface{}, error) {
	if o.IsMap() {
...
func (o *RefObj) SetByKey(key interface{}, val interface{}) (err error) {
	defer func() {
		if e := recover(); e != nil {
...
func (o *RefObj) GetByKey(key interface{}) (value interface{}, found bool) {
	defer func() {
		if err := recover(); err != nil {
			value = nil
			found = false
...
func (o RefObj) FieldsFlattened() []ObjField {
...
func (o RefObj) FieldsAll() []ObjField {
	return o.getFields(fieldsAll)
}

// FieldsAnonymous returns only anonymous fields.
func (o RefObj) FieldsAnonymous() []ObjField {
	return o.getFields(fieldsAnonymous)
}

func (o *RefObj) getFields(listingType fieldListingType) []ObjField {
...
func (o RefObj) FindDoubleFields() []string {
...
func (o *RefObj) Field(fieldName string) *ObjField {
...
func (o RefObj) Type() reflect.Type {
	return o.objType
}

// Kind returns the value's kind.
func (o RefObj) Kind() reflect.Kind {
	return o.objKind
}

func (o RefObj) String() string {
	if o.objType == nil {
		return "nil"
	}
...
func (o *RefObj) Method(name string) *ObjMethod {
...
func (o *RefObj) Methods() []ObjMethod {
...
func newObjField(obj *RefObj, metadata ObjFieldMetadata) *ObjField {
	res := &ObjField{
		obj:              obj,
...
func newObjMethod(obj *RefObj, objMethodMetadata ObjMethodMetadata) *ObjMethod {
	return &ObjMethod{
		obj:               obj,
