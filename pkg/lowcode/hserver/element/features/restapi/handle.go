...
type ApiHandle struct {
	...
	service         element2.Service
	tag             *element2.FuncTag
	fun             element2.Func
...
func Register(service element2.Service, fun element2.Func, tag *element2.FuncTag) {
...
func NewApiHandle(service element2.Service, tag *element2.FuncTag, fun element2.Func) *ApiHandle {
...
func (s *ApiHandle) run(ctx context.Context, wctx element2.WebContext, params any) {
	values := &element2.ApiRunValues{
		Server:     s.server,
		Service:    s.service,
		Self:       s.service,
		WebContext: wctx,
...
func (s *ApiHandle) GetParams(wctx element2.WebContext) any {
	var err error
