...
func NewFunc(server element2.Server, config *element2.FuncConfig, logger logrus.FieldLogger, reader fs.Reader, pkg *types.CMap[any]) (element2.Func, error) {
	if config == nil {
...
func (s *Func) Config() *element2.FuncConfig {
	return s.config
}
