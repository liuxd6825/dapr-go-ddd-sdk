...
func (a *RestAssembler) AsFindPagingRequest(ictx iris.Context) (*FindPagingRequest, error) {
	return a.assFindPagingRequest(ictx)
}

func (a *RestAssembler) assFindPagingRequest(ictx iris.Context) (*FindPagingRequest, error) {
