...
import (
	...
	"github.com/liuxd6825/dapr-go-ddd-sdk/os/gocsv"
...
func (d *Dao[T]) ImportNodeCsv(ctx context.Context, cmd ImportCsvCmd, opts ...store.Options) (err error) {
	return d.importCsv(ctx, cmd, opts...)
}

func (d *Dao[T]) ImportRelationCsv(ctx context.Context, cmd ImportCsvCmd, opts ...store.Options) (err error) {
	return d.importCsv(ctx, cmd, opts...)
}

func (d *Dao[T]) importCsv(ctx context.Context, cmd ImportCsvCmd, opts ...store.Options) (err error) {
	defer func() {
...
func (d *Dao[T]) ImportJson(ctx context.Context, cmd ImportJsonCmd, opts ...store.Options) (err error) {
	defer func() {
		err = errors.GetRecoverError(err, recover())
	}()
