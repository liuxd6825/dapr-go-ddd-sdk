...
func TransformTs(logger logrus.FieldLogger, tsCode string, fileName string) (string, error) {
	return TransformTSCodeToJS(tsCode), nil
}
...
// @param tsCode
// @return string
func TransformTSCodeToJS(tsCode string) string {
	// 正则表达式匹配 namespace 块
