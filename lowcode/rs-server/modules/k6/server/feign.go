...
func NewFeign(server *Server) *Feign {
	return &Feign{server: server}
}

func (f *Feign) Call(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) Get(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	options.Method = "get"
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) Post(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	options.Method = "post"
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) Put(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	options.Method = "put"
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) Delete(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	options.Method = "delete"
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) Patch(ctx context.Context, options *FeignOptions, params map[string]any) *common.Result[any] {
	options.Method = "patch"
	return f.InvokeMethod(ctx, options, params)
}

func (f *Feign) InvokeMethod(ctx context.Context, opts *FeignOptions, params map[string]any) (res *common.Result[any]) {
	var err error
	defer func() {
