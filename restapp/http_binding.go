...
func (s *HttpServer) AddBindingInvocationHandler(route string, fn common.BindingInvocationHandler) error {
	if route == "" {
	...
	s.app.HandleMany("", route, optionsHandler(http.HandlerFunc(
